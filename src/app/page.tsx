...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      {/* Hero Section */}
      <section className="pt-12 sm:pt-20 pb-12 sm:pb-16 px-4">
      ...
      <section className="py-12 sm:py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Feature 1 */}
            <div className="p-4 sm:p-6 border border-gray-200 rounded-lg hover:shadow-lg transition">
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6 bg-blue-600 text-white rounded-lg p-6 sm:p-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold">Ready to simplify your expenses?</h2>
